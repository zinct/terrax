          ...
          <section className="flex flex-row items-center justify-between relative my-24">
            <div className="flex-1">
              ...
              <div className="mt-10 space-x-5 flex">
                <div className="flex">
                  <input className="py-3 px-5 w-80 rounded-l-lg" type="text" placeholder="What are you looking for?"></input>
                ...
                <button className="text-white font-bold rounded-lg bg-gradient-to-r from-cyan-400 to-orange-400 py-3 px-5">Used Home</button>
                <button className="text-white font-bold rounded-lg border-2 border-cyan-400 p-3 px-5">New Home</button>
                <button className="text-white font-bold rounded-lg border-2 border-cyan-400 p-3 px-5">Land</button>
              </div>
            </div>
          </section>
          <section>
