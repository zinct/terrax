...
const PrimaryNavbar = () => {
  ...
  return (
    <header className="flex flex-row items-center justify-between my-5 z-50">
      ...
      <button className="w-24 h-12 text-white d-flex items-center justify-between font-medium rounded-[11px] bg-gradient-to-r from-cyan-400 to-orange-400 p-[2.5px] hover:cursor-pointer" onClick={authContext.connectIdentityProvider}>
