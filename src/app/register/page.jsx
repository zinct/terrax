          ...
          <div className="w-full bg-zinc-900 rounded-lg">
            <div className="flex overflow-x-auto">
              ...
              >
                <span
                  className={`bg-white ${
                    viewModel.step >= 2 ? "text-orange-400" : "text-zinc-800"
                  } p-2 rounded-full mr-3`}
                >
                  02
                </span>
            ...
            <div className="flex-none text-center p-10 space-y-3">
              ...
              <p className="text-white text-4xl font-bold">
                {viewModel.stepDetail[viewModel.step - 1].title}
              </p>
              <p className="text-gray-500">
                {viewModel.stepDetail[viewModel.step - 1].decs}
              </p>
            </div>
            {/* STEP 1 */}
            <div
            ...
            >
              <div className="flex-1 space-y-5">
                <div>
                  ...
                  <input
                    className="py-3 px-5 w-full rounded-lg bg-zinc-800 text-white"
                    type="text"
                    placeholder="Type Your Fullname Here"
                    name="name"
                    onChange={viewModel.formik.handleChange}
                    error={viewModel.formik.errors.name}
                  ></input>
                  <span className="text-[#F82F1E] mt-20">
                    {viewModel.formik.errors && viewModel.formik.errors.name}
                  </span>
                </div>
                <div>
                  ...
                  <input
                    ...
                    name="email"
                    onChange={viewModel.formik.handleChange}
                    error={viewModel.formik.errors.email}
                  ></input>
                  <span className="text-[#F82F1E]">
                    {viewModel.formik.errors && viewModel.formik.errors.email}
                  </span>
                </div>
                <button
                  {...viewModel.getRootProps({ className: "h-36 w-full" })}
                >
                  ...
                  <div className="dropzone flex justify-center py-3 px-5 w-full h-full rounded-lg border-[#9D9D9F] border-2 border-dashed basis-1/3">
                    <p className="text-zinc-500 flex items-center justify-center space-x-3">
                      ...
                      <span>
                        {files.length > 0 ? files : "Upload your photo here"}
                      </span>
              ...
              <div className="flex-1 mt-16 md:mt-0 space-y-5">
                <div>
                  ...
                  <div className="flex space-x-5">
                    <div>
                      <input
                        className="py-3 px-5 w-full rounded-lg bg-zinc-800 basis-1/3 text-white"
                        type="number"
                        name="day"
                        onChange={viewModel.formik.handleChange}
                        error={viewModel.formik.errors.day}
                        placeholder="DD"
                      ></input>
                      <span className="text-[#F82F1E]">
                        {viewModel.formik.errors && viewModel.formik.errors.day}
                      </span>
                    </div>
                    <div>
                      <input
                        ...
                        name="month"
                        onChange={viewModel.formik.handleChange}
                        error={viewModel.formik.errors.month}
                        placeholder="MM"
                      ></input>
                      <span className="text-[#F82F1E]">
                        {viewModel.formik.errors &&
                          viewModel.formik.errors.month}
                      </span>
                    </div>
                    <div>
                      <input
                        className="py-3 px-5 w-full rounded-lg bg-zinc-800 basis-2/3 text-white"
                        type="number"
                        name="year"
                        onChange={viewModel.formik.handleChange}
                        error={viewModel.formik.errors.year}
                        placeholder="YYYY"
                      ></input>
                      <span className="text-[#F82F1E]">
                        {viewModel.formik.errors &&
                          viewModel.formik.errors.year}
                      </span>
                    </div>
                  </div>
                </div>
                <div>
                  ...
                  <input
                    className="py-3 px-5 w-full rounded-lg bg-zinc-800 text-white"
                    type="text"
                    placeholder="Type Phone Address Here"
                    name="phone"
                    onChange={viewModel.formik.handleChange}
                    error={viewModel.formik.errors.phone}
                  ></input>
                  <span className="text-[#F82F1E]">
                    {viewModel.formik.errors && viewModel.formik.errors.address}
                  </span>
                </div>
                <div>
                  ...
                  <textarea
                    ...
                    name="address"
                    onChange={viewModel.formik.handleChange}
                    error={viewModel.formik.errors.address}
                  ></textarea>
                  <span className="text-[#F82F1E]">
                    {viewModel.formik.errors && viewModel.formik.errors.address}
                  </span>
            ...
            >
              ...
              <button
                {...viewModel.getRootProps2({ className: "h-full w-full" })}
              >
              ...
              <span className="text-[#F82F1E]">
                {viewModel.idCardError && "The ID Card Is Required"}
              </span>
            </div>
          </div>
